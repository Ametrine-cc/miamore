...
char *give_bg_color(colors_t color) {
  ...
  switch (color) {
  case red:
    return tc_supported ? true_bg_colors->red_str : rgb_bg_colors->red_str;
  case orange:
    return tc_supported ? true_bg_colors->orange_str
                        : rgb_bg_colors->orange_str;
  case yellow:
    return tc_supported ? true_bg_colors->yellow_str
                        : rgb_bg_colors->yellow_str;
  case green:
    return tc_supported ? true_bg_colors->green_str : rgb_bg_colors->green_str;
  case blue:
    return tc_supported ? true_bg_colors->blue_str : rgb_bg_colors->blue_str;
  case pink:
    return tc_supported ? true_bg_colors->pink_str : rgb_bg_colors->pink_str;
  case purple:
    return tc_supported ? true_bg_colors->purple_str
                        : rgb_bg_colors->purple_str;
  case cyan:
    return tc_supported ? true_bg_colors->cyan_str : rgb_bg_colors->cyan_str;
  case magenta:
    return tc_supported ? true_bg_colors->magenta_str
                        : rgb_bg_colors->magenta_str;
  case black:
    return tc_supported ? true_bg_colors->black_str : rgb_bg_colors->black_str;
  case white:
    return tc_supported ? true_bg_colors->white_str : rgb_bg_colors->white_str;
  default:
    return "";
  }
}
